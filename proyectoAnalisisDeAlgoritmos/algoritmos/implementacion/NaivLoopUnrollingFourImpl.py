...
from algoritmos.algoritmos.NaivLoopUnrollingFour import NaivLoopUnrollingFour
...
resultado = Resultado("NaivLoopUnrollingFour", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = NaivLoopUnrollingFour(matrizA, matrizB, Result, N, P, M)
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\NaivLoopUnrollingFourResultadoPython.json", "w") as archivo:
