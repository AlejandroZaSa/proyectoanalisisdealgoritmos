...
from algoritmos.algoritmos.WinogradScaled import WinogradScaled
...
resultado = Resultado("WinogradScaled", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = WinogradScaled(matrizA, matrizB, Result, N, P, M)
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\WinogradScaledResultadoPython.json", "w") as archivo:
