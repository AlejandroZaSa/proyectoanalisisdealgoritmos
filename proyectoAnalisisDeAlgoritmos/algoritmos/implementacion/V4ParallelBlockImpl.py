...
resultado = Resultado("V4ParallelBlock", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = V4ParallelBlock(matrizA, matrizB, Result, caso["tamanioBloques"])
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\V4ParallelBlockResultadoPython.json", "w") as archivo:
