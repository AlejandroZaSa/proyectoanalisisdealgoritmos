...
from algoritmos.algoritmos.III5EnhancedParallelBlock import III5EnhancedParallelBlock
...
resultado = Resultado("III5EnhancedParallelBlock", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = III5EnhancedParallelBlock(matrizA, matrizB, Result, caso["tamanioBloques"])
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\III5EnhancedParallelBlockResultadoPython.json", "w") as archivo:
