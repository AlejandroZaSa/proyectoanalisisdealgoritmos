...
from algoritmos.algoritmos.V3SequentialBlock import V3SequentialBlock
...
resultado = Resultado("V3SequentialBlock", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = V3SequentialBlock(matrizA, matrizB, Result, caso["tamanioBloques"])
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\V3SequentialBlockResultadoPython.json", "w") as archivo:
