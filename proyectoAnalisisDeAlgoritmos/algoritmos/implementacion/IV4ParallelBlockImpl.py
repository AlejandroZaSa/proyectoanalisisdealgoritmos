...
from algoritmos.algoritmos.IV4ParallelBlock import IV4ParallelBlock
...
resultado = Resultado("IV4ParallelBlock", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = IV4ParallelBlock(matrizA, matrizB, Result, caso["tamanioBloques"])
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\IV4ParallelBlockResultadoPython.json", "w") as archivo:
