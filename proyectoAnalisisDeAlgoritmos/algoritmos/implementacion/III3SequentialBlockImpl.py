...
from algoritmos.algoritmos.III3SequentialBlock import III3SequentialBlock
...
resultado = Resultado("III3SequentialBlock", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = III3SequentialBlock(matrizA, matrizB, Result, caso["tamanioBloques"])
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\III3SequentialBlockResultadoPython.json", "w") as archivo:
