...
from algoritmos.algoritmos.NaivOnArray import NaivOnArray
...
resultado = Resultado("NaivOnArray", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = NaivOnArray(matrizA, matrizB, Result, N, P, M)
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\NaivOnArrayResultadoPython.json", "w") as archivo:
