...
from algoritmos.algoritmos.IV5EnhancedParallelBlock import IV5EnhancedParallelBlock
...
resultado = Resultado("IV5EnhancedParallelBlock", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = IV5EnhancedParallelBlock(matrizA, matrizB, Result, caso["tamanioBloques"])
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\IV5EnhancedParallelBlockResultadoPython.json", "w") as archivo:
