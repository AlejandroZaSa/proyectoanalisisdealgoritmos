...
from algoritmos.algoritmos.StrassenNaiv import StrassenNaiv
...
resultado = Resultado("StrassenNaiv", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = StrassenNaiv(matrizA, matrizB, Result, N, P, M)
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\StrassenNaivResultadoPython.json", "w") as archivo:
