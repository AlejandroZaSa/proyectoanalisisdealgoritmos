...
resultado = Resultado("WinogradOriginal", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = WinogradOriginal(matrizA, matrizB, Result, N, P, M)
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\WinogradOriginalResultadoPython.json", "w") as archivo:
