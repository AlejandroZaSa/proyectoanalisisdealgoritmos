...
from algoritmos.algoritmos.StrassenWinograd import StrassenWinograd
...
resultado = Resultado("StrassenWinograd", [], "python")
...
for caso in casosPrueba:
    ...
    for i in range(caso["numMuestras"]):
        ...
        matrizResultado = StrassenWinograd(matrizA, matrizB, Result, N, P, M)
...
with open("C:\\Users\\Lenovo\\Documents\\ProyectoAA\\archivos\\resultados\\python\\StrassenWinogradResultadoPython.json", "w") as archivo:
